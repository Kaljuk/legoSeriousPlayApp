...
export default class SelectedPersonalScreen extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
        <View style={{flex:1, backgroundColor: '#88C9B3'}}>
            ...
            <Text style={{fontSize: 24, color: 'white',fontWeight: 'bold', marginTop:'1%', marginLeft:130, fontWeight:'500'}}>PERSONAL</Text>

            <TouchableOpacity style={{position: 'absolute', top: 125, left: 150}} onPress={()=> this.props.navigation.navigate('')}>
                <View style={{height: 80, width : 80, borderRadius: 40, backgroundColor: '#50a297'}}> </View>
                <Text style={{fontSize: 14, color: 'white',fontWeight: 'bold', marginTop:'2%', marginLeft:-18, fontWeight:'400'}}>Tutorial of Personal</Text>
            </TouchableOpacity>
