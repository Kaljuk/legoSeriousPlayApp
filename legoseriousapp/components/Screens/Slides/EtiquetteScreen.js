...
const IntroVideo = require('./../../../assets/videos/04etiquette.mp4');

export default class EtiquetteScreen extends React.Component {
	state = {
		mute: false,
		fullScreen: false,
		shouldPlay: true,
      ...
      <View style={styles.container}>
			<View>
				...
				<View style={{marginTop: '10%'}}>
					<Text style={{ textAlign: 'center', fontSize: 22, color: 'white', fontWeight: 'bold' }}>Etiquette</Text>
				</View>
			</View>
