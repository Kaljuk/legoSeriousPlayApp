...
export default class SelectedEducationScreen extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
        <View style={{flex:1, backgroundColor: '#B06495'}}>
            ...
            <Text style={{fontSize: 24, color: 'white',fontWeight: 'bold', marginTop:'1%', marginLeft:130, fontWeight:'500'}}>EDUCATION</Text>

            <TouchableOpacity style={{position: 'absolute', top: 125, left: 150}} onPress={()=> this.props.navigation.navigate('')}>
                <View style={{height: 80, width : 80, borderRadius: 40, backgroundColor: '#783479'}}> </View>
                <Text style={{fontSize: 14, color: 'white',fontWeight: 'bold', marginTop:'2%', marginLeft:-22, fontWeight:'400'}}>Tutorial of Education</Text>
            </TouchableOpacity>
